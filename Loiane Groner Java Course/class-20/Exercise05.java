  ...
  public static void main (String[] args) {
    ...
    for (int i = 0; i < schedule.length; i++) {
      switch (i + 1) {
        ...
        case 9: // Setembro
        case 11: // Novembro
          schedule[i] = new String[30][8];
          break;

        case 2: // Fevereiro
          schedule[i] = new String[isBisext ? 29 : 28][8];
          break;
    ...
    do {
      ...
      switch (option) {
        case 1:
          ...
          System.out.print("Digite a hora desejada: (Entre 8hrs e 15hrs) ");
        ...
        case 2:
          ...
          if (schedule[month][day][hour] == null) {
            ...
            System.out.println("\nCompromisso do dia " + (day + 1) + "/" + (month + 1) + " às " + (hour + 8) + "Hrs: " + schedule[month][day][hour] + "\n");
          }
          break;
        case 3:
